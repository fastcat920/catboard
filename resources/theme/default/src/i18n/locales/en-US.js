...
export default {
  ...
  order: {
    ...
    activity_discount: 'Limited-time Discount',
    discount: 'Discount',
    member_discount: 'Plan Discount ({rate}%)',
    trade_off_amount: 'Old Plan Offset',
    refund_amount: 'Returned to Balance',
    order_amount: 'Order Amount',
    balance_amount: 'Balance Applied',
    ...
    choose_promotion: 'Promotion option',
    coupon_loading: 'Finding eligible coupons…',
    best_coupon: 'Best coupon',
    best_promotion: 'Best option',
    promotion_exclusive_hint: 'Flash sales and coupons are mutually exclusive. Membership discounts are included when comparing the final prices.',
    promotion_final: 'Final price {amount}',
    promotion_saved: 'Total savings',
    member_promotion: 'Membership discount',
    member_promotion_desc: 'Includes your current {rate}% membership discount',
    regular_promotion: 'Regular price',
    regular_promotion_desc: 'Do not use the flash sale or a coupon',
    flash_promotion_desc: 'Use the current flash-sale price',
    no_discount: 'Full price',
