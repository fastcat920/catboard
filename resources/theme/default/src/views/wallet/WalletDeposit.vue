...
.deposit-container {
  ...
  .wallet-balance-column { width: 100%; min-width: 0; text-align: left; }
  .wallet-summary-title { display: flex; align-items: center; justify-content: flex-start; gap: 8px; font-size: 14px; opacity: .88; }
