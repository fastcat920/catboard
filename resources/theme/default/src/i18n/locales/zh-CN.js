...
export default {
  ...
  order: {
    ...
    subtotal: '小计',
    plan_amount: '套餐原价',
    activity_discount: '限时优惠',
    discount: '优惠',
    member_discount: '套餐优惠（{rate}%）',
    trade_off_amount: '旧套餐抵扣',
    refund_amount: '差额退回余额',
    order_amount: '订单金额',
    balance_amount: '余额抵扣',
    payable_amount: '还需支付',
    total: '总计',
    ...
    choose_coupon: '选择优惠券',
    choose_promotion: '优惠方案',
    coupon_loading: '正在匹配可用优惠券…',
    best_coupon: '最优优惠券',
    best_promotion: '最优方案',
    promotion_exclusive_hint: '限时活动与优惠券互斥，系统会将会员等级折扣一并计算并自动选择最终价格最低的方案。',
    promotion_final: '最终价格 {amount}',
    promotion_saved: '共优惠',
    member_promotion: '会员等级折扣',
    member_promotion_desc: '享受当前会员等级 {rate}% 套餐折扣',
    regular_promotion: '普通价格方案',
    regular_promotion_desc: '不使用限时活动或优惠券',
    flash_promotion_desc: '使用当前限时活动价格',
    no_discount: '原价',
  ...
  wallet: {
    ...
    records: {
      ...
      time: '时间', type: '类型', amount: '变动金额', status: '状态', total: '共 {total} 条', previous: '上一页', next: '下一页',
