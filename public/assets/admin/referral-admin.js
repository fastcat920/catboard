(function () {
    ...
    function renderShell() {
            root.innerHTML = '<div class="p-0 p-lg-4"><div class="mb-0 block border-bottom"><nav class="nav nav-tabs nav-tabs-block">' + [["overview","数据概览"],["setting","奖励规则"],["levels","成长等级"],["milestones","成长里程碑"],["leaderboard","排行榜"],["relations","邀请关系"],["rewards","奖励流水"]].map(function (item) {
    ...
    function loadTab() {
        ({ overview: loadOverview, setting: loadSetting, levels: loadLevels, milestones: loadMilestones, leaderboard: loadLeaderboard, relations: loadRelations, rewards: loadRewards }[tab] || loadOverview)();
    }
